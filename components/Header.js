            ...
            <div className='max-w-xs'>
                ...
                <div className='absolute inset-y-0 pl-3 flex items-center pointer-events-none'>
                  <SearchIcon className="h-5 w-5 text-gray-500"/> 
                    ...
                    <input  className="bg-gray-50 w-full pl-10 sm:text-sm border-gray-300 hover:border-black focus:ring-black rounded-md" 
...
// <div className='relative navbtn'>
//     <PaperAirplaneIcon className='navBtn rotate-45'/>
// <div className='hidden first-letter:absolute -top-1 -right-2 text-xs w-5 h-5 bg-red-500 rounded-full items-center justify-center text-white'>3</div>
// </div>
