    ...
    return (
        <div className="bg-white my-7 border rounded-sm"> 
            ...
            {/* <div className="flex items-center p-5">
                <img src={userImg} className="rounded-full h-12 w-12 object-contain corder p-1 mr-3"alt="" />
                <p className="flex-1 font-bold">{username}</p>
                <TrashIcon onClick={deletePost} className="h-5"/>
            </div> */}
            ...
            <div className="flex items-center p-5">
                <img
                    src={userImg}
                    className="rounded-full h-12 w-12 object-contain corder p-1 mr-3"
                    alt=""
                />
                <p className="flex-1 font-bold">{username}</p>
                {session && session.user && session.user.username === username && (
                <TrashIcon onClick={() => deletePost(id)} className="h-5" />
                )}
            </div>
